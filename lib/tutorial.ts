...
export const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  },
  {
    id: "faces",
    eyebrow: "The faces",
    title: "Even hits. Odd blocks.",
    body: `Every number on every ship does two jobs. Evens are Attack — they hurt the enemy flagship. Odds are Shields — they soak Attack before it lands. The number itself is how hard it hits or blocks: a 6 hits for 6, a 5 blocks for 5.`,
  ...
  },
  {
    ...
    body: `Some faces also pay a mark. A 1 pays 2 Energy. A 2 fires 2 Direct (damage shields cannot stop). A 3 repairs 3. Higher even and odd faces carry smaller marks too — look for the lightning, the Direct label, and the pluses on the dice. Energy is the purse for the shipyard and for extra rerolls.`,
  ...
  },
  {
    ...
    body: "Bigger hulls hit harder and can show higher faces — but they match threes less often. A d6 is the bridge: still useful for lines, better for straights. Bigger ships also soak more when you brace.",
  ...
  },
  {
    id: "brace_teach",
    eyebrow: "Brace",
    title: "Feed a ship to save the flagship",
    body: "Tap one or more ships, then confirm. Each ship blocks as many hit points as its hull size (a d4 blocks 4, a d10 blocks 10), then sits out the next round stunned. Bigger hulls are better cannon fodder — that is another reason to grow them.",
    allow: { brace: true },
  },
  {
    id: "report2",
    ...
    body: "Shields stop Attack first. Direct ignores shields. Braced ships eat what is left. Then Repair lands. Tap through when you have read the line.",
    allow: { continue: true },
  },
  {
    id: "roll3",
